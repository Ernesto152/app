...
public class PortfolioCollectionActivity_ViewBinding implements Unbinder {
  private PortfolioActivity target;

  @UiThread
  public PortfolioCollectionActivity_ViewBinding(PortfolioActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public PortfolioCollectionActivity_ViewBinding(PortfolioActivity target, View source) {
    this.target = target;
