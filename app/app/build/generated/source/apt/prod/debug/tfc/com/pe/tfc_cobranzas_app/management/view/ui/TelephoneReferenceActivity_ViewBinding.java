...
public class TelephoneReferenceActivity_ViewBinding implements Unbinder {
  private TelephoneReferenceActivity target;

  @UiThread
  public TelephoneReferenceActivity_ViewBinding(TelephoneReferenceActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TelephoneReferenceActivity_ViewBinding(TelephoneReferenceActivity target, View source) {
    this.target = target;
    ...
    target.contactPhoneEditText = Utils.findRequiredViewAsType(source, R.id.contactPhoneEditText, "field 'contactPhoneEditText'", EditText.class);
  ...
  public void unbind() {
    ...
    target.contactPhoneEditText = null;
